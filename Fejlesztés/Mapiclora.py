...
def extract_params_png(text):
    try:
        ...
        # Ckpt
        ckpt = re.search(r'ckpt_name:\s*(\d+)', text)
        ckpt = seed.group(1) if ckpt else "-"
...
class ImageViewer(QWidget): 
    ...
    def show_image(self, fname):
        ...
        <!-- <span class="key3">🌀 Denoise:</span> {result[8]} &nbsp;&nbsp;&nbsp;&nbsp;
        <span class="key3">🧠 VAE:</span> {result[9]} &nbsp;&nbsp;&nbsp;&nbsp; -->
        <span class="key3">✨ Lora:</span> {result[10]} &nbsp;&nbsp;&nbsp;&nbsp;
        """
